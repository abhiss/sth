...
namespace sthv
{
	static class sthvHuntStart
	{
		...
		public static async void HunterVehicles(int gametimeInMsec = 25)
		{
			...
			veh = await World.CreateVehicle(new Model(VehicleHash.Tampa2), new Vector3(370.3453f, -1690.081f, 47.95068f), 48.4f);
			...
			vehList.Add(veh);
			veh = await World.CreateVehicle(new Model(VehicleHash.Dune2), new Vector3(377.0466f, -1681.64f, 47.91183f), 48.4f);
			...
			vehList.Add(veh);
			veh = await World.CreateVehicle(new Model(VehicleHash.SultanRS), new Vector3(383.7508f, -1673.141f, 48.29026f), 48.4f);
			vehList.Add(veh);
			veh = await World.CreateVehicle(new Model(VehicleHash.Maverick), new Vector3(382.9529f, -1656.624f, 48.69487f), 48.4f); //heli
			vehList.Add(veh);
